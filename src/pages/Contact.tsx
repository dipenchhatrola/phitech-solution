            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 items-stretch justify-center">
               ...
               >
                  ...
                  <div className="flex space-x-3 mb-8">
                     <a href="mailto:info@phitech.co.in" className="w-[34px] h-[34px] rounded-full bg-[#ea4335] flex items-center justify-center text-white hover:opacity-80 transition-opacity shadow-sm" title="Email Us">
